...
const FINISH_HREFS = [
  ...
  '/capabilities/finish/laser-marking',
  '/capabilities/finish/polishing',
  '/capabilities/finish/blackening',
]
    ...
    <header ref={headerRef} className={`site-header${isHome ? '' : ' is-light'}`}>
      <div className="topbar">
        ...
        <div className="nav-actions">
          <a className="login-link" href={entryUrl('/login', isEnglish ? 'en' : 'zh')}>
            {t('nav.login')}
          </a>
          <Link className="btn btn-primary" to="/quote#quote-upload">
            {t('nav.quote')}
          </Link>
          <button
            type="button"
