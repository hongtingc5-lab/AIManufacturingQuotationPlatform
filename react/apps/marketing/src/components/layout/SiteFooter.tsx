...
const MENU_HREFS: string[][] = [
  ...
  ['/', '/quote', '/capabilities/service/custom', '/about/company', '/about#contact'],
  [
    '/industries',
  ...
  ['/about', '/about/company', '/about/quality', '/about/privacy', '/about/terms'],
]
          ...
          <section className="footer-support-card">
            ...
            <div className="footer-contact-details">
              ...
              <p className="footer-contact-line">
                ...
                <a href="/about#contact">{support.contactOnline}</a>
              </p>
            </div>
          </section>
