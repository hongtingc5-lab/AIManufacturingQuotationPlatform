...
/* Header relocate / hide / quote-jump / hero rotation → src/interactions/siteChrome.ts */
    ...
    (function () {
      const resourcesTrigger = Array.from(document.querySelectorAll(".nav-dropdown > .nav-item"))
        .find((item) => item.textContent.trim() === "资源中心");
      const resourceLinks = resourcesTrigger?.nextElementSibling?.querySelector(".nav-menu-links");
      if (!resourceLinks) return;
      const hasModelCommunity = Array.from(resourceLinks.children)
        .some((link) => link.textContent.trim() === "模型社区");
      if (hasModelCommunity) return;
      const modelCommunity = document.createElement("a");
      modelCommunity.href = "../%E7%94%A8%E6%88%B7%EF%BC%88%E5%B7%B2%E6%A0%B8%E5%AF%B9%EF%BC%89/%E6%8A%A5%E4%BB%B7%E6%A8%A1%E5%9E%8B%E4%B8%8A%E4%BC%A0%E9%A1%B5%E6%9C%AA%E7%99%BB%E5%BD%95.html";
      modelCommunity.textContent = "模型社区";
      resourceLinks.insertBefore(modelCommunity, resourceLinks.children[1] || null);
    })();
}
